...
[![Build Status](https://travis-ci.org/mrmalhotra/@kollorg/hic-exercitationem.svg?branch=master)](https://travis-ci.org/mrmalhotra/@kollorg/hic-exercitationem)
[![GitHub package version](https://img.shields.io/github/package-json/v/mrmalhotra/@kollorg/hic-exercitationem.svg)]()
![alt text](https://img.shields.io/badge/Built%20With-LOVE-red.svg)
[![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/mrmalhotra/@kollorg/hic-exercitationem.svg)]()
...
using npm
```
$ npm install @kollorg/hic-exercitationem -g
```

In Node.js:

```
const generate = require('@kollorg/hic-exercitationem');
...
**Usage**
```
let string = "@kollorg/hic-exercitationem hash"
...
**@kollorg/hic-exercitationem** is licensed under the MIT license.